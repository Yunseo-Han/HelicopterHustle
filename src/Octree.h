...
public:
    ...
    bool intersect(const vector<Box>, TreeNode & node, vector<Box> & boxListRtn);
	...
	vector<ofColor> colors = {ofColor::red, ofColor::orange, ofColor::yellow, ofColor::green, ofColor::blue, ofColor::indigo, ofColor::violet};
	ofMesh mesh;
	TreeNode root;
